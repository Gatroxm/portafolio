    ...
    <div class="container-custom">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div class="lg:col-span-2">
          <h3 class="text-xl font-bold mb-4">Gabriel Troncoso</h3>
        ...
        <div>
          ...
          <ul class="space-y-2 text-secondary-300">
            <li class="flex items-center gap-2">
              ...
              <a href="mailto:gabriel.troncoso.dev@gmail.com" 
                 class="hover:text-white transition-colors duration-200">
                gabriel.troncoso.dev@gmail.com
              </a>
            </li>
            <li class="flex items-center gap-2">
              <PhoneIcon class="w-4 h-4" />
              <a href="https://wa.me/+573133976999" 
                 target="_blank" 
                 rel="noopener noreferrer"
                 class="hover:text-white transition-colors duration-200">
                +57 313 397 69 99
      ...
      <div class="border-t border-secondary-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-secondary-300 text-sm">
          © {{ currentYear }} Gabriel Troncoso. Todos los derechos reservados.
        </p>
        <div class="flex items-center gap-4 text-sm text-secondary-300">
          <span>Hecho con ❤️ en Vue.js</span>
          <a href="https://github.com/Gatroxm/portfolio" 
             target="_blank" 
             rel="noopener noreferrer"
