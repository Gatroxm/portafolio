          ...
          <div>
            ...
            <div class="space-y-4">
              <div v-for="contact in contactInfo" 
                ...
                <div class="w-12 h-12 bg-primary-100 group-hover:bg-primary-200 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors duration-200">
...
const contactInfo = [
  {
    type: 'email',
    label: 'Email',
    value: 'gabriel.troncoso.dev@gmail.com',
    href: 'mailto:gabriel.troncoso.dev@gmail.com',
    icon: EnvelopeIcon,
    external: false
  },
  {
